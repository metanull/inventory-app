...
class StoreTest extends TestCase
{
    ...
    public function test_store_returns_unprocessable_entity_when_input_is_invalid()
    {
        ...
        $response->assertJsonValidationErrors(['glossary_id', 'language_id', 'spelling', 'id']);
    }
    ...
    public function test_store_returns_the_expected_data()
    {
        ...
        $response->assertJsonPath('data.spelling', $data['spelling']);
    }
    ...
    public function test_store_validates_required_fields()
    {
        ...
        $response = $this->postJson(route('glossary-spelling.store'), $data);
        $response->assertUnprocessable();
        $response->assertJsonValidationErrors(['glossary_id', 'language_id', 'spelling']);
    }
