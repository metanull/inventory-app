...
trait TestsWebPermissions
{
    ...
    protected function assertRouteRequiresPermission(
        ...
        // Generate minimal data for POST/PATCH/PUT requests if not provided
        ...
        $response = $this->{strtolower($method)}(route($route, $routeParams), $data);
