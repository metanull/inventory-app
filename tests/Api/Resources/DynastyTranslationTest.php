...
class DynastyTranslationTest extends TestCase
{
    ...
    {
        return 'dynasty-translation';
    }

    protected function getModelClass(): string
    {
        return DynastyTranslation::class;
    }

    /**
     * Override to handle JSON fields properly (extra is JSON in DB)
     */
