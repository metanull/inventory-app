...
------------ | ------------- | ------------- | -------------
**data** | [**Array&lt;ItemItemLinkResource&gt;**](ItemItemLinkResource.md) |  | [default to undefined]
...
```typescript
import { ItemItemLinkIndex200Response } from './api';

const instance: ItemItemLinkIndex200Response = {
    data,
    links,
    meta,
};
