...
**display_order** | **number** | Display order among siblings sharing the same parent, nullable | [default to undefined]
...
**start_date** | **number** | The start year for the item (for datation purposes) | [default to undefined]
**end_date** | **number** | The end year for the item (for datation purposes) | [default to undefined]
