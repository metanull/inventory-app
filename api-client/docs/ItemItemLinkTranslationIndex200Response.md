...
------------ | ------------- | ------------- | -------------
**data** | [**Array&lt;ItemItemLinkTranslationResource&gt;**](ItemItemLinkTranslationResource.md) |  | [default to undefined]
...
```typescript
import { ItemItemLinkTranslationIndex200Response } from './api';

const instance: ItemItemLinkTranslationIndex200Response = {
    data,
    links,
    meta,
};
