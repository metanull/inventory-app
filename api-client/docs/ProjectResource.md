...
**is_launched** | **string** | Indicates if the project has been launched already | [default to undefined]
**is_enabled** | **string** | Indicates if the project is enabled (active) | [default to undefined]
