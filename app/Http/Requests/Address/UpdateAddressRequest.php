...
class UpdateAddressRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'id' => 'prohibited',
            'internal_name' => 'required|string|unique:addresses,internal_name,'.($address ? $address->id : 'NULL'),
    ...
    public function messages(): array
    {
        return [
            ...
            'translations.*.language_id.required_with' => 'A language is required for each translation.',
            'translations.*.language_id.exists' => 'The selected language is invalid.',
            'translations.*.address.required_with' => 'The address text is required for each translation.',
        ];
    }
}
