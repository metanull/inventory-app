...
class DownloadPictureRequest extends FormRequest
{
    /**
    ...
    {
        return [
            // No query parameters allowed for download endpoint for security
        ];
    }
    ...
    public function withValidator(Validator $validator): void
    {
        $validator->after(function ($validator) {
            $allowedParameters = []; // No query parameters allowed
