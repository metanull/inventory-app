...
class GlossaryTable extends Component
{
    use WithPagination;
    ...
    public function getGlossariesProperty()
    {
    ...
    {
        $c = config('app_entities.glossary.colors', []);

        return view('livewire.tables.glossary-table', [
