...
describe('useApiClient composable', () => {
  ...
  it('should create API client instances with session-aware axios', () => {
    ...
    expect(typeof apiClient.createDetailApi).toBe('function')
    expect(typeof apiClient.createExhibitionApi).toBe('function')
    expect(typeof apiClient.createGalleryApi).toBe('function')
    ...
    expect(typeof apiClient.createPictureApi).toBe('function')
    ...
    expect(typeof apiClient.createDetailTranslationApi).toBe('function')
    expect(typeof apiClient.createExhibitionTranslationApi).toBe('function')
    ...
    expect(typeof apiClient.createPictureTranslationApi).toBe('function')
