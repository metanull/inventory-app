...
describe('Project Consistency Tests', () => {
  const projectListPath = path.resolve(__dirname, '../../Projects.vue')
  const projectDetailPath = path.resolve(__dirname, '../../ProjectDetail.vue')

  describe('Projects.vue - List View Compliance', () => {
    ...
    it('should use format components instead of raw data in table cells', () => {
      ...
      expect(content).toContain('<DateDisplay :date="project.created_at"')
    })
    ...
    it('should use centralized color system consistently', () => {
      ...
      // Should default to 'orange' for projects
      expect(content).toContain("color: 'orange'")
  ...
  describe('ProjectDetail.vue - Detail View Compliance', () => {
  ...
  describe('Navigation and Menu Integration', () => {
    ...
    it('should use named routes consistently for navigation', () => {
      ...
      expect(content).toContain("router.push({ name: 'projects' })")

      // Should NOT use string paths for main navigation
      expect(content).not.toContain("router.push('/projects')")
      expect(content).not.toContain('router.push("/projects")')
    })
