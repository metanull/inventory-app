        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex items-center justify-between">
                    ...
                    <a href="{{ route('partner-translations.show', $partnerTranslation) }}" 
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                <form method="POST" action="{{ route('partner-translations.partner-translation-images.update', [$partnerTranslation, $partnerTranslationImage]) }}" class="p-6 space-y-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="flex justify-center">
                        <div class="w-64 h-64 bg-gray-100 dark:bg-gray-700 rounded-lg overflow-hidden">
                            <img src="{{ route('partner-translations.partner-translation-images.view', [$partnerTranslation, $partnerTranslationImage]) }}" 
                                 alt="{{ $partnerTranslationImage->alt_text ?? 'Translation image' }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               name="alt_text" 
                               id="alt_text" 
                               value="{{ old('alt_text', $partnerTranslationImage->alt_text) }}"
                    ...
                    <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm text-gray-600 dark:text-gray-400">{{ $partnerTranslationImage->display_order }}</span>
                        </div>
                    </div>
