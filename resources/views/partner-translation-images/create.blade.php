    ...
    <div class="min-h-screen bg-gray-50 dark:bg-gray-900 py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">
                            Attach Image to {{ $partnerTranslation->name }}
                        </h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            Select an available image to attach to this translation
                        </p>
                    </div>
            ...
            <div class="bg-white dark:bg-gray-800 shadow-sm rounded-lg">
                <form method="POST" action="{{ route('partner-translations.partner-translation-images.store', $partnerTranslation) }}" class="p-6 space-y-6">
                    @csrf
