    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('partner-translations.create', ['partner_id' => $partner->id]) }}" 
        ...
        <div class="p-6">
            ...
            @if($translationsByContext->isEmpty())
                <div class="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by adding a translation for this partner.</p>
                    <div class="mt-6">
                        <a href="{{ route('partner-translations.create', ['partner_id' => $partner->id]) }}" 
                           class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-150">
                            <x-heroicon-o-plus class="h-4 w-4 mr-1" />
                                ...
                                <div class="bg-white rounded-lg overflow-hidden border border-gray-200">
                                    <div class="p-4">
                                        ...
                                        <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-200">
                                            <!-- View -->
                                            <a href="{{ route('partner-translations.show', $translation) }}" 
                                            ...
                                            <!-- Edit -->
                                            <a href="{{ route('partner-translations.edit', $translation) }}" 
                                            ...
                                            <!-- Delete -->
                                            <form method="POST" action="{{ route('partner-translations.destroy', $translation) }}" 
