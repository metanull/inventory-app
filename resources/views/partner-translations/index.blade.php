...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <x-entity.header entity="partner-translations" title="Partner Translations">
        @can(\App\Enums\Permission::CREATE_DATA->value)
            <x-ui.button :href="route('partner-translations.create')" variant="primary" entity="partner-translations" icon="plus">
                Add Translation
            </x-ui.button>
        @endcan
    </x-entity.header>
    ...
    @if(session('status'))
        <x-ui.alert :message="session('status')" type="success" entity="partner-translations" />
    @endif
        ...
        <div class="bg-white shadow ring-1 ring-black ring-opacity-5 sm:rounded-lg overflow-hidden">
            <table class="min-w-full divide-y divide-gray-200">
                <x-table.header>
                    ...
                    <x-table.header-cell hidden="hidden md:table-cell">Partner</x-table.header-cell>
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($partnerTranslations as $translation)
                        <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='{{ route('partner-translations.show', $translation) }}'">
