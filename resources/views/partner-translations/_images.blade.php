    ...
    <div class="bg-white shadow-sm rounded-lg">
        <div class="px-6 py-4 border-b border-gray-200">
            <div class="flex items-center justify-between">
                ...
                <a href="{{ route('partner-translations.partner-translation-images.create', $partnerTranslation) }}" 
        ...
        <div class="p-6">
            ...
            @if($images->isEmpty())
                <div class="text-center py-12 bg-gray-50 rounded-lg">
                    ...
                    <p class="mt-1 text-sm text-gray-500">Get started by attaching an image to this translation.</p>
                    <div class="mt-6">
                        <a href="{{ route('partner-translations.partner-translation-images.create', $partnerTranslation) }}" 
                           class="inline-flex items-center px-4 py-2 bg-blue-600 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition ease-in-out duration-150">
                            Attach First Image
                    ...
                    @foreach($images as $image)
                        <div class="bg-white rounded-lg overflow-hidden border border-gray-200">
                            ...
                            <div class="aspect-square bg-gray-200">
                                <img src="{{ route('partner-translations.partner-translation-images.view', [$partnerTranslation, $image]) }}" 
                            ...
                            <div class="p-4 space-y-3">
                                ...
                                <div class="flex flex-wrap gap-2 pt-2 border-t border-gray-200">
                                    <!-- Edit -->
                                    <a href="{{ route('partner-translations.partner-translation-images.edit', [$partnerTranslation, $image]) }}" 
                                    ...
                                    <!-- Move Up -->
                                    <form method="POST" action="{{ route('partner-translations.partner-translation-images.move-up', [$partnerTranslation, $image]) }}" class="inline">
                                        @csrf
                                        <button type="submit" 
                                    ...
                                    <!-- Move Down -->
                                    <form method="POST" action="{{ route('partner-translations.partner-translation-images.move-down', [$partnerTranslation, $image]) }}" class="inline">
                                        @csrf
                                        <button type="submit" 
                                                class="inline-flex items-center px-3 py-1.5 bg-gray-600 border border-transparent rounded text-xs text-white hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition">
                                            <svg class="w-3 h-3 mr-1" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                    ...
                                    <!-- Detach -->
                                    <form method="POST" action="{{ route('partner-translations.partner-translation-images.detach', [$partnerTranslation, $image]) }}" class="inline" onsubmit="return confirm('Detach this image and return it to available images?');">
                                        @csrf
                                        <button type="submit" 
