...
<div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 lg:px-8">
    <x-entity.header entity="glossaries" title="Glossary">
        @can(\App\Enums\Permission::CREATE_DATA->value)
            <x-ui.button :href="route('glossaries.create')" variant="primary" entity="glossaries" icon="plus">
                Add Entry
            </x-ui.button>
        @endcan
    </x-entity.header>
    ...
    @if(session('status'))
        <x-ui.alert :message="session('status')" type="success" entity="glossaries" />
    @endif
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    @forelse($glossaries as $glossary)
                        <tr class="hover:bg-gray-50 cursor-pointer" onclick="window.location='{{ route('glossaries.show', $glossary) }}'">
