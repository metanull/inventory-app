 ...
 *
 *  - too narrow (`mwnf3:hcr:country:%` alone, which is what this exporter
 *    originally shipped) loses the Sharing History "Political Context"
 *    chronology: 8 of the 26 countries the live API serves disappear and 315 of
 *    its 1,390 events go with them;
