 ...
 * (amulets: ar, en, es, fr), but an individual record offers whatever languages
 * it happens to have — the sheet's language switcher is built from the record,
 * not the site — and amulets' borrowed items add de, el and tr. Both are
 * needed, and nothing else is: exporting the whole `languages` table would ship
 * 180 rows of names the site can never show.
 */
