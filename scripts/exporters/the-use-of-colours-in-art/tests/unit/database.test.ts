...
describe('Database.resolveExhibition', () => {
  ...
  it('reads the anchor the importer wrote to collections.extra', async () => {
    ...
    const exhibition = await db.resolveExhibition('mwnf3_thematic_gallery:thg_gallery:47')
  ...
  it('fails loudly when the exhibition is absent', async () => {
    ...
    await expect(db.resolveExhibition('mwnf3_thematic_gallery:thg_gallery:47')).rejects.toThrow(
