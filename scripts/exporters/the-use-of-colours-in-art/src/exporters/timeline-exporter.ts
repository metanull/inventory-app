 ...
 * `/thg/timeline` returns these 45 gallery-47 events, while `/events` returns
 ...
 * true / false; carpets: false / false), and they gate nav entries rather than
 * the data. So the package ships both sets in one pair of files and each
 * timeline says which chronology it belongs to via `source`.
 *
 ...
 * `mwnf3_thematic_gallery:thg_gallery:47` → `47`. Returns null rather than
