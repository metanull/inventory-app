...
exports.BackwardCompatibilityFormatter = void 0;
class BackwardCompatibilityFormatter {
    /**
     ...
     */
    static formatDenormalized(schema, table, pkColumns, excludeColumns = ['lang', 'language', 'language_id']) {
     ...
     */
    static formatImage(schema, table, itemPkValues, imageIndex) {
        return this.format({ schema, table, pkValues: [...itemPkValues, imageIndex] });
    }
}
exports.BackwardCompatibilityFormatter = BackwardCompatibilityFormatter;
//# sourceMappingURL=BackwardCompatibilityFormatter.js.map