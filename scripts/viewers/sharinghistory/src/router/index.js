...
import ExhibitionFurtherReading from '../views/ExhibitionFurtherReading.vue'
...
const routes = [
  ...
  { path: '/exhibitions/:exhibitionId/further-reading', component: ExhibitionFurtherReading },
