#!/usr/bin/env node
//
// Vendor the Carpets UI catalogue into src/i18n/.
//
...
//
// Run it from scripts/viewers/carpets. It is pure file shuffling — no network,
...
// gallery.json's `slug`. Carpets is the one gallery whose legacy slug happens
// to equal its folder name — that is a coincidence, not a rule, so this stays
// spelled out rather than derived (see the exporter README, "Naming").
const SITE_SLUG = 'carpets'
...
// record fixes at ar/en/es/fr for carpets.
