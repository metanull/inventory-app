**CRITICAL: Comply with the instructions in [.github/environment.instructions.md](.github/environment.instructions.md), it describes the project's environment setup and requirements.**
