...
> **Python script for the generation of the pages**: [generate-commit-docs.py](https://github.com/metanull/inventory-management-ui/blob/main/scripts/generate-commit-docs.py)
