...
**CRITICAL: Run the generate-commit-docs.py script from the parent directory like: `wsl bash -c 'cd /mnt/e/inventory/inventory-app && python3 scripts/generate-commit-docs.py'`**
