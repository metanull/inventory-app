...
- **Python scripts** - To generate documentation from Git commits and API client. See [/scripts/README.md](../scripts/README.md)
- **GitHub Actions** - For automated deployment. See [/.github/workflows/README.md](../.github/workflows/README.md#deploy-documentation-to-github-pages)
...
| -------------------------- | ---------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------- |
| `_docs/`                   | `generate-commit-docs.py`          | Git commit history converted to markdown. See [/scripts/README.md](../scripts/README.md#generating-the-git-commit-history)                      |
| `api-client/`              | `generate-client-docs.py`          | TypeScript API client documentation. See [/scripts/README.md](../scripts/README.md#generating-the-api-client-npm-packages-static-documentation) |
| `_model/`                  | `generate-model-documentation.ps1` | Laravel model documentation (schemas, relationships). See [/scripts/README.md](../scripts/README.md#auto-generating-the-model-documentation)    |
...
- CI/CD workflow on push to `main`. See [/.github/workflows/README.md](../.github/workflows/README.md#deploy-documentation-to-github-pages)
...
**See:** [/scripts/README.md](../scripts/README.md#generating-the-git-commit-history) for details
...
**See:** [/scripts/README.md](../scripts/README.md#generating-the-api-client-npm-packages-static-documentation) for details
...
**See:** [/scripts/README.md](../scripts/README.md#generation-of-the-static-documentation-website) for script details
...
**See:** [/.github/workflows/README.md](../.github/workflows/README.md#deploy-documentation-to-github-pages) for workflow details
...
- Validate workflow changes with `node scripts/validate-workflows.cjs`. See [/scripts/README.md](../scripts/README.md#validation-of-the-workflow-files)
